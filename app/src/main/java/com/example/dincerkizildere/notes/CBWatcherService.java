...
public class CBWatcherService extends Service {
    ...
    public final static String INTENT_EXTRA_FORCE_SHOW_NOTIFICATION = "com.example.dincerkizildere.notes.EXTRA.FORCE_SHOW_NOTIFICATION";
    public final static String INTENT_EXTRA_MY_ACTIVITY_ON_FOREGROUND_MESSAGE = "com.example.dincerkizildere.notes.EXTRA.MY_ACTIVITY_ON_FOREGROUND_MESSAGE";
    public final static String INTENT_EXTRA_CHANGE_STAR_STATUES = "com.example.dincerkizildere.notes.EXTRA.CHANGE_STAR_STATUES";
    public final static String INTENT_EXTRA_TEMPORARY_STOP = "com.example.dincerkizildere.notes.EXTRA.TEMPORARY_STOP";
    public final static String INTENT_EXTRA_CHECK_CLIPBOARD_NOW = "com.example.dincerkizildere.notes.EXTRA.CHECK_CLIPBOARD_NOW";
    ...
    private void showNotification() {
        ...
        NotificationCompat.Builder preBuildNotification = new NotificationCompat.Builder(this, "M_CH_ID")
    ...
    private void showSingleNotification() {
        ...
        NotificationCompat.Builder preBuildN = new NotificationCompat.Builder(this,"M_CH_ID")
                .setContentIntent(pOpenMainDialogIntent)
    ...
    private class NotificationClipListAdapter {
        ...
        public List<Notification> getWearNotifications() {
            ...
            for (ClipObject clip : clips) {
                notifications.add(new NotificationCompat.Builder(mContext,"M_CH_ID")
