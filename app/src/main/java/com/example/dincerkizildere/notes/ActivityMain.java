...
public class ActivityMain extends MyActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMessageReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent ıntent) {
                if (ıntent.getBooleanExtra(Storage.UPDATE_DB_ADD, false)) {
                    setView();
                } else {
                    clipCardAdapter.remove(ıntent.getStringExtra(Storage.UPDATE_DB_DELETE));
                }
            }
        };
    ...
    protected void onResume() {
        ...
        if (isStarred != tmpStarred) {
            ...
            mFAB.setImageResource(tmpStarred ?
                    R.drawable.ic_action_star_white : R.drawable.ic_action_add);
        ...
        if (preference.getBoolean(FIRST_LAUNCH, true)) {
            try {
                ...
                Log.e(MyUtil.PACKAGE_NAME, "İlk Başlatma Hatası:");
                e.printStackTrace();
            }
        }
        if (getString(R.string.screen_type).contains("phone")) {
    ...
    @Override
    protected void onNewIntent(Intent ıntent) {
        super.onNewIntent(ıntent);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /*searchView.setOnActionExpandListener(searchItem, new MenuItem.OnActionExpandListener() {
            @Override
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (getString(R.string.screen_type).contains("phone")) {
                    ...
                    mFAB.animate().scaleX(0).scaleX(0);
                }
    ...
    private void mFabRotation(boolean clockwisw, long time) {
        if (isRotating) return;
        mFAB.setRotation(0);
        float rotateDegree = (clockwisw ? 360 : -360);
        isRotating = true;
        mFAB.animate()
    ...
    private void initView() {
        ...
        SwipeableRecyclerViewTouchListener swipeableRecyclerViewTouchListener = new SwipeableRecyclerViewTouchListener(context, mRecList, R.id.main_view, R.id.main_background_view,
        ...
        mRecList.addOnItemTouchListener(swipeableRecyclerViewTouchListener);
        if (getString(R.string.screen_type).contains("phone")) {
    ...
    public  class ClipCardAdapter extends RecyclerView.Adapter<ClipCardAdapter.ClipCardViewHolder>{
        ...
        @Override
        public void onBindViewHolder(@NonNull final ClipCardAdapter.ClipCardViewHolder clipCardViewHolder, int i) {
            ...
            if (clipObject.isStarred()){
                ...
                clipCardViewHolder.vText.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.ic_lock,0);
            }else{
        ...
        @NonNull
        @Override
        public ClipCardViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            View itemView=LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_main_card,viewGroup,false);
